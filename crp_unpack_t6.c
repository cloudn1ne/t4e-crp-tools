/**************************************************************
* Lotus T6 (2008+) CRP file extractor
*
* (c) CyberNet, 2021
*
*
...
// the XTEA 128bit key for T6
uint32_t k[4]= {0x340D2EB9,0xC41A93EE,0x73FAFED5,0x47C80F57 };
...
{
  printf("\n\n");
  printf("./crp_unpack_t6 -f <CRP firmware file>\n");  
  printf("\n\n");
}
...
{  
  ...
  crp_chunks = (*(uint32_t*)crp_buffer);
  printf("CRP Chunks: %d\n", crp_chunks-1);  
